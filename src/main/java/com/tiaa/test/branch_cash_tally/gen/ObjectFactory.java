 ...
 * generated in the com.tiaa.test.branch_cash_tally.gen package. 
...
public class ObjectFactory {
    ...
    private final static QName _Cmfoodchain_QNAME = new QName("http://www.example.org/branchDataFile", "cmfoodchain");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.tiaa.test.branch_cash_tally.gen
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.example.org/branchDataFile", name = "cmfoodchain")
